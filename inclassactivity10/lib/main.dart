...
class _SignupPageState extends State<SignupPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold( // 👨 Parent
      appBar: AppBar(
        centerTitle: true,
        title: const Text('WASSUP BROTHA!!!', style: TextStyle(fontSize:32, fontWeight: FontWeight.bold)),
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (!value.contains('.com')&&!value.contains('.org')&&!value.contains('.mil')&&!value.contains('.net')&&!value.contains('.edu')) {
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Welcome! Punk, I mean ${_nameController.text} created successfully.'),
